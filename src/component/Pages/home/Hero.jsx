      ...
      <div className="relative z-30 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl text-white">
            {/* Trust Badge */}
            {/* <span className="inline-block mb-4 px-4 py-1 text-sm rounded-full bg-green-600/90">
              Physiotherapy at Home • Online Consultation
            </span> */}
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              index === current ? "bg-green-500 scale-125" : "bg-white/60"
            }`}
          />
        ))}
      </div> */}
